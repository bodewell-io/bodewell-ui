...
import { Card } from '../layout/Card'; // Updated to a named import
import { Avatar } from '../ui/Avatar'; // Assuming avatar is now consistently exported
 ...
 */
// Refactored to use a named export
